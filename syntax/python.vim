...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonEscape			StrFormat
  HiLink pythonUniEscape		StrFormat
  HiLink pythonUniRawEscape		StrFormat
  HiLink pythonStrFormatting	StrFormat
  HiLink pythonStrFormat	    StrFormat
  HiLink pythonStrTemplate	    StrFormat
  ...
  HiLink pythonBuiltinFunc  Statement
